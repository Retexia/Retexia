                    ...
                    <form className="space-y-8">
                        ...
                        <div className={`transition-all duration-500 ${step === 1 ? 'block opacity-100' : 'hidden opacity-0'}`}>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                <div>
                                    ...
                                    <input type="text" id="name" placeholder="Jane Doe" className="w-full bg-[#1f2937] border border-white/10 rounded-xl px-5 py-4 text-white focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all placeholder-gray-600" />
                                </div>
                                <div>
                                    <label htmlFor="email" className="block text-sm font-medium text-gray-300 mb-2">Email Address</label>
                                    <input type="email" id="email" placeholder="jane@company.com" className="w-full bg-[#1f2937] border border-white/10 rounded-xl px-5 py-4 text-white focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all placeholder-gray-600" />
                                </div>
                            </div>
                            ...
                            <div className="mb-8">
                                ...
                                <input type="text" id="app_name" placeholder="My Awesome App" className="w-full bg-[#1f2937] border border-white/10 rounded-xl px-5 py-4 text-white focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all placeholder-gray-600" />
                            </div>
                            ...
                            <div>
                                ...
                                <select id="purpose" className="w-full bg-[#1f2937] border border-white/10 rounded-xl px-5 py-4 text-white appearance-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all" defaultValue="">
                        ...
                        <div className={`transition-all duration-500 ${step === 2 ? 'block opacity-100' : 'hidden opacity-0'}`}>
                            ...
                            <div className="mb-8">
                                ...
                                <div className="space-y-3">
                                    <label className="block cursor-pointer">
                                        <input type="radio" name="platform" value="ios" className="peer sr-only" />
                                    ...
                                    <label className="block cursor-pointer">
                                        <input type="radio" name="platform" value="android" className="peer sr-only" />
                                        <div className="bg-[#1f2937] border border-white/10 rounded-xl px-5 py-4 text-gray-300 peer-checked:bg-emerald-600/20 peer-checked:border-emerald-500 peer-checked:text-white transition-all hover:bg-white/5">
                                            Google Play Store (Androids only)
                                        </div>
                                    </label>
                                    <label className="block cursor-pointer">
                                        <input type="radio" name="platform" value="both" className="peer sr-only" defaultChecked />
                                        <div className="bg-[#1f2937] border border-white/10 rounded-xl px-5 py-4 text-gray-300 peer-checked:bg-emerald-600/20 peer-checked:border-emerald-500 peer-checked:text-white transition-all hover:bg-white/5">
                            ...
                            <div className="mb-8">
                                ...
                                <div className="flex gap-4">
                                    <label className="flex-1 cursor-pointer">
                                        <input type="radio" name="needs_sync" value="yes" className="peer sr-only" />
                                    ...
                                    <label className="flex-1 cursor-pointer">
                                        <input type="radio" name="needs_sync" value="no" className="peer sr-only" defaultChecked />
                                        <div className="text-center bg-[#1f2937] border border-white/10 rounded-xl px-5 py-4 text-gray-300 peer-checked:bg-emerald-600/20 peer-checked:border-emerald-500 peer-checked:text-white transition-all hover:bg-white/5">
                                            No
                                        </div>
                                    </label>
                            ...
                            <div className="mb-8">
                                ...
                                <div className="flex gap-4">
                                    <label className="flex-1 cursor-pointer">
                                        <input type="radio" name="needs_auth" value="yes" className="peer sr-only" defaultChecked />
                                        <div className="text-center bg-[#1f2937] border border-white/10 rounded-xl px-5 py-4 text-gray-300 peer-checked:bg-emerald-600/20 peer-checked:border-emerald-500 peer-checked:text-white transition-all hover:bg-white/5">
                                            Yes
                                        </div>
                                    </label>
                                    <label className="flex-1 cursor-pointer">
                                        <input type="radio" name="needs_auth" value="no" className="peer sr-only" />
                                        <div className="text-center bg-[#1f2937] border border-white/10 rounded-xl px-5 py-4 text-gray-300 peer-checked:bg-emerald-600/20 peer-checked:border-emerald-500 peer-checked:text-white transition-all hover:bg-white/5">
                                            No
                                        </div>
                                    </label>
                            ...
                            <div className="mb-8">
                                ...
                                <div className="flex gap-4">
                                    <label className="flex-1 cursor-pointer">
                                        <input type="radio" name="needs_payments" value="yes" className="peer sr-only" />
                                        <div className="text-center bg-[#1f2937] border border-white/10 rounded-xl px-5 py-4 text-gray-300 peer-checked:bg-emerald-600/20 peer-checked:border-emerald-500 peer-checked:text-white transition-all hover:bg-white/5">
                                            Yes
                                        </div>
                                    </label>
                                    <label className="flex-1 cursor-pointer">
                                        <input type="radio" name="needs_payments" value="no" className="peer sr-only" defaultChecked />
                                        <div className="text-center bg-[#1f2937] border border-white/10 rounded-xl px-5 py-4 text-gray-300 peer-checked:bg-emerald-600/20 peer-checked:border-emerald-500 peer-checked:text-white transition-all hover:bg-white/5">
                                            No
                                        </div>
                                    </label>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                    {['Camera / Photo Library', 'GPS / Location Services', 'Push Notifications', 'Bluetooth'].map((hw) => (
                                        <label key={hw} className="flex items-center p-4 rounded-xl border border-white/10 bg-[#1f2937] cursor-pointer hover:bg-white/5 transition-colors">
                                            <input type="checkbox" className="w-5 h-5 rounded border-gray-600 text-emerald-500 focus:ring-emerald-500/20 bg-gray-700" />
                        ...
                        <div className={`transition-all duration-500 ${step === 3 ? 'block opacity-100' : 'hidden opacity-0'}`}>
                            ...
                            <div className="mb-8">
                                ...
                                <select id="design_status" className="w-full bg-[#1f2937] border border-white/10 rounded-xl px-5 py-4 text-white appearance-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all" defaultValue="">
                            ...
                            <div className="mb-8">
                                ...
                                <select id="timeline" className="w-full bg-[#1f2937] border border-white/10 rounded-xl px-5 py-4 text-white appearance-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all" defaultValue="">
                            ...
                            <div className="mb-8">
                                ...
                                <select id="budget" className="w-full bg-[#1f2937] border border-white/10 rounded-xl px-5 py-4 text-white appearance-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all" defaultValue="">
                            ...
                            <div>
                                ...
                                <textarea id="pitch" rows={5} placeholder="It's like Uber, but for dog walking! I want users to be able to track their walkers in real-time..." className="w-full bg-[#1f2937] border border-white/10 rounded-xl px-5 py-4 text-white focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all placeholder-gray-600 resize-none"></textarea>
                            </div>
                        </div>
                        ...
                        <div className="pt-8 flex justify-between items-center border-t border-white/10 mt-10">
                            ...
                            {step < totalSteps ? (
                                ...
                                <button
                                    type="submit"
                                    onClick={(e) => { e.preventDefault(); alert('Mobile App Request Submitted!'); }}
